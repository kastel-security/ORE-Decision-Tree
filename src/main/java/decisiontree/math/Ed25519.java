...
/**
 * This is a copy of {@link org.bouncycastle.math.ec.rfc8032.Ed25519} with modified access modifiers to allow
 * accessing internal methods and types.
 */
public abstract class Ed25519
{
    ...
    static class F extends X25519Field {};
    ...
    static boolean decodePointVar(byte[] p, int pOff, boolean negate, PointAffine r)
    {
...
//        assert carry == 0;
    ...
    static void pointAdd(PointExtended p, PointExtended q, PointExtended r, PointTemp t)
    {
...
//        assert q != r;
    ...
    static void pointCopy(PointAffine p, PointExtended r)
    {
        F.copy(p.x, 0, r.x, 0);
        F.copy(p.y, 0, r.y, 0);
        F.one(r.z);
...
//        assert x09 == 0L || x09 == -1L;
    ...
    static void scalarMult(byte[] k, PointAffine p, PointAccum r)
    {
